...
namespace DormWebApplication.Controllers
{
    public class FurnituresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,RoomId")] Furniture furniture)
        {
            ...
            ViewData["RoomId"] = new SelectList(_context.Rooms, "Id", "Id", furniture.RoomId);
            return View(furniture);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,RoomId")] Furniture furniture)
        {
            if (id != furniture.Id)
            {
                return NotFound();
