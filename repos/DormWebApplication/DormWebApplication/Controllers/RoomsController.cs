...
namespace DormWebApplication.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CountPlace,FloorId,Resident,Number")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CountPlace,FloorId,Resident,Number")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
